...
const char *makis = "Los makis de Mary";
///
// Constants
///
...
void autonomo24() {
    ...
    //Giramos para entrar hacia el cargador
   ...
   /* chassis.pid_turn_set(-45,TURN_SPEED);
    ...
    //Entrar al cargador
    chassis.pid_drive_set(6.3_in, 40, true);
    chassis.pid_wait();
    ...
    chassis.pid_drive_set(-6.8_in, 80, true);
    chassis.pid_wait();
...
chassis.pid_swing_set(ez::RIGHT_SWING, -90_deg, 50);
chassis.pid_wait();
    ...
    chassis.pid_drive_set(17.5_in, 80, true);
    chassis.pid_wait();
    ...
    //IR hacia atras despues de anotar el primer cargador
    chassis.pid_drive_set(-17.5_in, DRIVE_SPEED, true);
    chassis.pid_wait();

        

    //Giramos para acomodarlo para dar la vuelta a 90 grados
    ...
    chassis.pid_wait();
    //Giramos para ir al lado contrario
   chassis.pid_swing_set(ez::RIGHT_SWING, -90_deg, 50);
chassis.pid_wait();



    chassis.pid_drive_set(70, 40, true);
    chassis.pid_wait();
    ...
    chassis.pid_wait();
       ...
       chassis.pid_drive_set(12.5, 50, true);
    chassis.pid_wait();
 ...
 cargador.extend();
      ...
      chassis.pid_drive_set(-8.2_in, 45, true);
    chassis.pid_wait();
   ...
   intake11W.move(-127);
    ...
    stage2.move(127);
          ...
          chassis.pid_drive_set(16.35_in, 60, true);
    chassis.pid_wait();
...
chassis.pid_swing_set(ez::LEFT_SWING, 90_deg, 50);
chassis.pid_wait();


lift1.extend();
lift2.extend();
 chassis.pid_drive_set(17.8_in, 80, true);
    chassis.pid_wait();
...
void autonomo_arriesgado_24(){
 //Avanzando a alinearse con cargador
    chassis.pid_drive_set(21_in, 50, true);
    chassis.pid_wait();
...
void skills24(){
  ...
  chassis.pid_drive_set(46_in, 30, true);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(-2_in, 30, true);
  chassis.pid_wait();

    chassis.pid_turn_set(-90,TURN_SPEED);
  chassis.pid_wait();

   chassis.pid_drive_set(45_in, 30, true);
  chassis.pid_wait();
  ...
  chassis.pid_wait();
   ...
   chassis.pid_drive_set(40_in, 25, true);
  chassis.pid_wait();
